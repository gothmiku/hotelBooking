...
--
-- Host: localhost    Database: hotelchart
-- ------------------------------------------------------
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hotel` (
  `HotelName` char(25) DEFAULT NULL,
  `RoomNumber` int DEFAULT NULL,
  `Availability` binary(2) DEFAULT NULL,
...
CREATE TABLE `rooms` (
  ...
  `SingleBedNo` int DEFAULT NULL,
  `DoubleBedNo` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-04 23:29:05
